...
const { getServices, updateServiceOrMenu, getServiceById, deleteService } = require("../controllers/service.controllers");
...
router.get('/:progressionId/services/:serviceId', getServiceById);
router.put('/:progressionId/services/:serviceId', authenticateUser, updateServiceOrMenu);
router.delete('/progressions/:progressionId/services/:serviceId', deleteService);
